...
//{
//    internal class DatabaseNode : DataTreeNode
//    {
//        public DatabaseNode(DataTreeViewBuilder builder, DataConnection connection, string databaseName)
//            : base(builder)
//        {
...
//        {
//            foreach (SqlTableSource dataSource in Connection.InformationSchema.Tables)
//            {
//                if (dataSource.Catalog.Equals(DatabaseName))
//                {
//                    yield return new DataTableNode(Builder, dataSource);
